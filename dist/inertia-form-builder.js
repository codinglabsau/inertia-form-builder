...
import { defineComponent as P, computed as h, ref as w, watch as ee, provide as te, h as U, cloneVNode as Bt, reactive as $t, onMounted as W, Fragment as ge, watchEffect as q, inject as Q, onUnmounted as ne, nextTick as J, unref as X, getCurrentInstance as Cn, Teleport as Pn, normalizeClass as st, openBlock as L, createBlock as ae, mergeProps as he, withCtx as Ie, renderSlot as se, toRaw as pe, createElementBlock as K, createTextVNode as dt, toDisplayString as Se, createCommentVNode as we, createElementVNode as re, withDirectives as Xe, isRef as Rn, vModelCheckbox as Fn, createVNode as ze, vShow as Ot, shallowRef as Nt, triggerRef as Et, onScopeDispose as An, renderList as De, resolveDynamicComponent as Dn, toHandlers as Mn } from "vue";
const kn = /* @__PURE__ */ re("circle", {
  ...
  setup(e) {
    ...
    return (l, r) => t.value === "button" ? (L(), K("button", he({
      key: 0,
      class: o,
      disabled: l.loading,
      type: l.type
...
function ft(e, n = 0) {
  var t;
  return e === ((t = fe(e)) == null ? void 0 : t.body) ? !1 : Y(n, { [0]() {
    return e.matches(et);
  }, [1]() {
    let o = e;
    for (; o !== null; ) {
...
var de = ((e) => (e[e.None = 0] = "None", e[e.RenderStrategy = 1] = "RenderStrategy", e[e.Static = 2] = "Static", e))(de || {}), me = ((e) => (e[e.Unmount = 0] = "Unmount", e[e.Hidden = 1] = "Hidden", e))(me || {});
...
yl(() => {
  function e(n) {
    n.target instanceof HTMLElement && n.target !== document.body && ce[0] !== n.target && (ce.unshift(n.target), ce = ce.filter((t) => t != null && t.isConnected), ce.splice(10));
  }
...
P({ name: "Combobox", emits: { "update:modelValue": (e) => !0 }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: !1 }, by: { type: [String, Function], nullable: !0, default: null }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: !0 }, name: { type: String, optional: !0 }, nullable: { type: Boolean, default: !1 }, multiple: { type: [Boolean], default: !1 }, immediate: { type: [Boolean], default: !1 }, virtual: { type: Object, default: null } }, inheritAttrs: !1, setup(e, { slots: n, attrs: t, emit: o }) {
  ...
  let m = h(() => e.multiple ? 1 : 0), O = h(() => e.nullable), [y, I] = ol(h(() => e.modelValue), (g) => o("update:modelValue", g), h(() => e.defaultValue)), B = h(() => y.value === void 0 ? Y(m.value, { [1]: [], [0]: void 0 }) : y.value), S = null, D = null;
  function R(g) {
    return Y(m.value, { [0]() {
  ...
  let b = { comboboxState: l, value: B, mode: m, compare(g, E) {
    ...
    return Y(m.value, { [0]: () => b.compare(pe(b.value.value), pe(g)), [1]: () => pe(b.value.value).some((E) => b.compare(pe(E), pe(g))) });
  }, isActive(g) {
    return f.value === b.calculateIndex(g);
  } };
  pt([a, i, u], () => b.closeCombobox(), h(() => l.value === 0)), te(ln, b), mt(h(() => Y(l.value, { [0]: G.Open, [1]: G.Closed })));
  let V = h(() => {
    var g;
...
P({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(e, { attrs: n, slots: t }) {
  var o;
  let l = (o = e.id) != null ? o : `headlessui-combobox-label-${Z()}`, r = Ee("ComboboxLabel");
  function a() {
    var i;
...
P({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(e, { attrs: n, slots: t, expose: o }) {
  var l;
  let r = (l = e.id) != null ? l : `headlessui-combobox-button-${Z()}`, a = Ee("ComboboxButton");
...
P({ name: "ComboboxInput", props: { as: { type: [Object, String], default: "input" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, displayValue: { type: Function }, defaultValue: { type: String, default: void 0 }, id: { type: String, default: null } }, emits: { change: (e) => !0 }, setup(e, { emit: n, attrs: t, slots: o, expose: l }) {
  var r;
  let a = (r = e.id) != null ? r : `headlessui-combobox-input-${Z()}`, i = Ee("ComboboxInput"), u = h(() => fe(x(i.inputRef))), s = { value: !1 };
  ...
  function m(S) {
    switch (s.value = !0, S.key) {
      case A.Enter:
        ...
        break;
      case A.ArrowDown:
        return s.value = !1, S.preventDefault(), S.stopPropagation(), Y(i.comboboxState.value, { [0]: () => i.goToOption(k.Next), [1]: () => i.openCombobox() });
      case A.ArrowUp:
        return s.value = !1, S.preventDefault(), S.stopPropagation(), Y(i.comboboxState.value, { [0]: () => i.goToOption(k.Previous), [1]: () => {
          i.openCombobox(), J(() => {
  ...
  function y(S) {
    var D, R, N;
    let b = (D = S.relatedTarget) != null ? D : ce.find((V) => V !== S.currentTarget);
  ...
  function I(S) {
    var D, R, N;
    let b = (D = S.relatedTarget) != null ? D : ce.find((V) => V !== S.currentTarget);
    (R = x(i.buttonRef)) != null && R.contains(b) || (N = x(i.optionsRef)) != null && N.contains(b) || i.disabled.value || i.immediate.value && i.comboboxState.value !== 0 && (i.openCombobox(), Oe().nextFrame(() => {
  ...
  return () => {
    ...
    return $({ ourProps: F, theirProps: M, slot: E, attrs: t, slots: o, features: de.RenderStrategy | de.Static, name: "ComboboxInput" });
  };
} });
P({ name: "ComboboxOptions", props: { as: { type: [Object, String], default: "ul" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, hold: { type: [Boolean], default: !1 } }, setup(e, { attrs: n, slots: t, expose: o }) {
  let l = Ee("ComboboxOptions"), r = `headlessui-combobox-options-${Z()}`;
  ...
  return Qt({ container: h(() => x(l.optionsRef)), enabled: h(() => l.comboboxState.value === 0), accept(u) {
    ...
    return $({ ourProps: d, theirProps: v, slot: f, attrs: n, slots: l.virtual.value && l.comboboxState.value === 0 ? { ...t, default: () => [U(Il, {}, t.default)] } : t, features: de.RenderStrategy | de.Static, visible: i.value, name: "ComboboxOptions" });
  };
} });
P({ name: "ComboboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: !1 }, order: { type: [Number], default: null } }, setup(e, { slots: n, attrs: t, expose: o }) {
  let l = Ee("ComboboxOption"), r = `headlessui-combobox-option-${Z()}`, a = w(null);
  o({ el: a, $el: a });
  let i = h(() => {
    var y;
...
let Ce = Object.assign(P({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: w(/* @__PURE__ */ new Set()) } }, inheritAttrs: !1, setup(e, { attrs: n, slots: t, expose: o }) {
  ...
  function d(v) {
    ...
    m instanceof HTMLElement && m.dataset.headlessuiFocusGuard !== "true" && (sn(p, m) || (c.value ? Fe(x(l), Y(u.value, { [Re.Forwards]: () => ue.Next, [Re.Backwards]: () => ue.Previous }) | ue.WrapAround, { relativeTo: v.target }) : v.target instanceof HTMLElement && be(v.target)));
  }
  return () => {
...
P({ name: "Dialog", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, open: { type: [Boolean, String], default: Ne }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (e) => !0 }, setup(e, { emit: n, attrs: t, slots: o, expose: l }) {
  ...
  Ft(M, T), Vl({ type: "Dialog", enabled: h(() => O.value === 0), element: p, onUpdate: (j, H) => {
    if (H === "Dialog")
      return Y(j, { [lt.Add]: () => f.value += 1, [lt.Remove]: () => f.value -= 1 });
  } });
  ...
  return _l(m, St, (j) => {
    ...
    return U(nt, { force: !0 }, () => [U(vn, () => U(Wl, { target: p.value }, () => U(nt, { force: !1 }, () => U(Ce, { initialFocus: H, containers: R, features: y.value ? Y(V.value, { parent: Ce.features.RestoreFocus, leaf: Ce.features.All & ~Ce.features.FocusLock }) : Ce.features.None }, () => U(D, {}, () => $({ ourProps: oe, theirProps: { ...le, ...t }, slot: We, attrs: t, slots: o, visible: O.value === 0, features: de.RenderStrategy | de.Static, name: "Dialog" })))))), U(b)]);
  };
} });
...
P({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(e, { slots: n, attrs: t }) {
  ...
  }, h(() => o.value === 0)), te(mn, f), mt(h(() => Y(o.value, { [0]: G.Open, [1]: G.Closed }))), () => {
...
P({ name: "MenuItems", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, id: { type: String, default: null } }, setup(e, { attrs: n, slots: t, expose: o }) {
  ...
  return () => {
    ...
    return $({ ourProps: O, theirProps: m, slot: p, attrs: n, slots: t, features: de.RenderStrategy | de.Static, visible: f.value, name: "MenuItems" });
  };
} });
...
let bn = de.RenderStrategy, ro = P({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: !0 }, appear: { type: [Boolean], default: !1 }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => !0, afterEnter: () => !0, beforeLeave: () => !0, afterLeave: () => !0 }, setup(e, { emit: n, attrs: t, slots: o, expose: l }) {
  ...
  W(() => {
    ...
    if (f.value === me.Hidden && I) {
      ...
      Y(O.value, { hidden: () => m(I), visible: () => p(I) });
    }
  });
  ...
  }), te(gt, S), mt(h(() => Y(O.value, { visible: G.Open, hidden: G.Closed }) | r.value)), () => {
...
const bo = {
  ...
  setup(e) {
    return (n, t) => (L(), K("div", yo, [
      re("div", {
        class: st(["mt-1 w-full rounded-md", { "shadow-sm": n.shadow }])
      }, [
        se(n.$slots, "default")
      ], 2),
      n.description ? (L(), K("p", xo, Se(n.description), 1)) : we("", !0),
      n.error ? (L(), ae(gn, {
        key: 1,
        error: n.error
      }, null, 8, ["error"])) : we("", !0)
...
const Vo = /* @__PURE__ */ P({
  ...
  setup(e, { emit: n }) {
    ...
    return (r, a) => (L(!0), K(ge, null, De(r.items, (i, u) => {
      var s, c, f;
      return L(), ae(X(Lo), {
...
const Ho = { key: 0 }, wt = /* @__PURE__ */ P({
  ...
  setup(e) {
    ...
    return ee(n.form, (f) => {
      ...
      o.value.hasOwnProperty("error") ? we("", !0) : (L(!0), K(ge, { key: 1 }, De(r.value, (v, p) => (L(), ae(X(gn), {
        key: p,
        error: v
      }, null, 8, ["error"]))), 128))
    ])) : we("", !0);
  }
}), Uo = { class: "mx-auto mt-6 max-w-md space-y-6" }, Zo = /* @__PURE__ */ P({
  __name: "FormBuilder",
  props: {
    schema: {},
    submit: { default: "Save" }
  ...
  setup(e) {
    return (n, t) => (L(), K("div", Uo, [
      (L(!0), K(ge, null, De(n.schema.elements, (o, l) => (L(), ae(wt, {
        key: l,
        element: o,
        form: n.schema.form
      }, null, 8, ["element", "form"]))), 128)),
      se(n.$slots, "actions-wrapper", {
        form: n.schema.form
      }, () => [
        ze(X(Po), null, {
          default: Ie(() => [
...
}), Go = { class: "grid gap-x-4 gap-y-6 md:grid-flow-col" }, Xo = /* @__PURE__ */ P({
  __name: "Grid",
  props: {
    schema: {},
    form: {}
  ...
  setup(e) {
    const t = xt(e.schema);
    return (o, l) => (L(), K("div", Go, [
      (L(!0), K(ge, null, De(X(t), (r, a) => (L(), ae(wt, he({
        key: a,
        element: r,
        form: o.form,
        ref_for: !0
...
}, qo = { class: "mt-4 space-y-6" }, er = /* @__PURE__ */ P({
  __name: "Section",
  props: {
    schema: {},
    form: {},
  ...
  setup(e) {
    const t = xt(e.schema);
    return (o, l) => (L(), K("div", Wo, [
      re("label", null, Se(o.heading), 1),
      o.description ? (L(), K("p", Ko, Se(o.description), 1)) : we("", !0),
      re("div", qo, [
        (L(!0), K(ge, null, De(X(t), (r, a) => (L(), ae(wt, {
          key: a,
          element: r,
          form: o.form
        }, null, 8, ["element", "form"]))), 128))
